...
function newGame() 
{
    ...
    switch(x)
    {
        case 1: correctColor = t1.style.background;
        case 2: correctColor = t2.style.background;
        case 3: correctColor = t3.style.background;
        case 4: correctColor = t4.style.background;
        case 5: correctColor = t5.style.background;
        case 6: correctColor = t6.style.background;
        case 7: correctColor = t7.style.background;
        case 8: correctColor = t8.style.background;
        case 9: correctColor = t9.style.background;
    }
